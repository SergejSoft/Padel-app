    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-green-600">{gamesPerPlayer}</div>
              <div className="text-sm text-gray-600">Games per Player</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">{Math.round(totalGames * avgGameMinutes / 60)}</div>
                            ...
                            <div className="flex-shrink-0">
                              {canEditScores() ? (
                                ...
                                <div className="text-sm text-gray-500 px-3 py-2 bg-gray-100 rounded">
                                  Score: {gameScores[match.gameNumber]?.team1Score || 0} - {gameScores[match.gameNumber]?.team2Score || 0}
                                </div>
                              )}
                            </div>
                          </div>
